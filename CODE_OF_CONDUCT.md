...
Instances of abusive, harassing, or otherwise unacceptable behavior may be reported privately using the contact method on the maintainer's GitHub profile. If no private contact is available, open a minimal issue asking the maintainer to establish a private channel; do not include sensitive details in that issue.
